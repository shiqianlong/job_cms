# Generated by Django 3.2 on 2021-04-15 05:04
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('school', models.CharField(blank=True, max_length=135, verbose_name='学校')),
                ('gender', models.CharField(blank=True, choices=[('男', '男'), ('女', '女')], max_length=135, verbose_name='性别')),
                ...
                ('upgrade_date', models.DateTimeField(auto_now=True, null=True, verbose_name='更新时间')),
                ('last_editor', models.CharField(blank=True, max_length=256, verbose_name='最后编辑者')),
                ('apply_position', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='jobs.job', verbose_name='应聘职位')),
